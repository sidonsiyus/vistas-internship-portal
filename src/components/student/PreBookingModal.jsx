      ...
      <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden font-sans">
        ...
        <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">Save your time before queuing for a consultation</p>
            </div>
          </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 p-3.5 rounded-xl text-xs text-blue-900 leading-relaxed">
            <strong>Before booking a consultation token:</strong> If your inquiry is regarding whether a company has responded to an internship request, eligibility guidelines, or application status, <span className="text-blue-950 font-bold">your question may already have been answered on the Company Response Board!</span>
          </div>
                ...
                {recentCompanyReplies.map(item => (
                  ...
                  >
                    <div className="min-w-0">
                      <p className="font-semibold text-slate-900 truncate">{item.companyName || item.title}</p>
                      <p className="text-[11px] text-slate-500 truncate mt-0.5">{item.title}</p>
                    </div>
        ...
        <div className="p-5 border-t border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row items-center justify-end gap-2.5">
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 hover:text-slate-900 font-semibold text-xs border border-slate-200 shadow-sm transition-colors"
          >
