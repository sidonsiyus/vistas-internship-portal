    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-5 rounded-2xl shadow-sm">
          <span className="text-[11px] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">TOTAL APPOINTMENTS</span>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-5 rounded-2xl shadow-sm">
          <span className="text-[11px] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">COMPLETION RATE</span>
          ...
          <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">{metrics.completedCount} completed today</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-5 rounded-2xl shadow-sm">
          <span className="text-[11px] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">AVG CONSULTATION TIME</span>
          <div className="text-3xl font-extrabold text-blue-600 dark:text-blue-400 font-mono mt-1">
            {metrics.avgDurationMinutes} Mins
          </div>
          <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">Target: 15 Mins / slot</p>
        </div>

        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-5 rounded-2xl shadow-sm">
          <span className="text-[11px] text-slate-500 dark:text-slate-400 font-semibold uppercase tracking-wider">NO-SHOW STUDENTS</span>
          <div className="text-3xl font-extrabold text-rose-600 dark:text-rose-400 font-mono mt-1">
            {metrics.noShowCount}
          </div>
          <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">Automatically unqueued</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-6 rounded-2xl shadow-sm space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-[11px] text-slate-600 dark:text-slate-400">
            {categoryData.map(c => (
